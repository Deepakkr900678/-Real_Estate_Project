      ...
      <div className="S-container">
        <div className="S-formDiv">
          ...
          <form action="/signup" method="POST" onSubmit={handleSignup}>
            ...
            <input id="S-userid" type="email" required={true} name="email" placeholder="EMAIL ID"/>
            <input id="S-password" name="password" required={true} type="password" placeholder="PASSWORD"/>
            <input id="S-confirmpassword" name="confirmpassword" required={true} type="password" placeholder="CONFIRM PASSWORD"/>
